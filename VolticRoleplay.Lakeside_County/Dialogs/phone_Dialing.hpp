...
class HRP_Phone_Dialing
{
	...
	class controls
	{
		...
		class background_P: RscPicture
		{
			...
			text = "\RedRoleplay_Client2\icons\phone\call\Dialing.paa";
			x = 0.4175 * safezoneW + safezoneX;
			y = 0.203 * safezoneH + safezoneY;
			w = 0.155375 * safezoneW;
			h = 0.520001 * safezoneH;
		...
		{
			idc = 1603;
			action = "closeDialog 0; [] call HRP_fnc_cancelCall";

			x = 0.439259 * safezoneW + safezoneX;
			y = 0.52552 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.075 * safezoneH;
			colorBackground[] = {0,0,0,0};
			colorActive[] = {0,0,0,0};
		...
		class AddP_B: RscButton
		{
			...
			x = 0.508662 * safezoneW + safezoneX;
			y = 0.52552 * safezoneH + safezoneY;
			w = 0.04125 * safezoneW;
			h = 0.075 * safezoneH;
			colorBackground[] = {0,0,0,0};
