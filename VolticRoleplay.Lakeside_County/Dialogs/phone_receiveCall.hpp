...
class HRP_Phone_receiveCall
{
	...
	class controls
	{
		...
		class background_P: RscPicture
		{
			...
			text = "\RedRoleplay_Client2\icons\phone\call\PhoneCallRecieved.paa";
			x = 0.4175 * safezoneW + safezoneX;
			y = 0.203 * safezoneH + safezoneY;
			w = 0.155375 * safezoneW;
			h = 0.520001 * safezoneH;
		...
		class Accept_B: RscButton
		{
			...
			colorFocused[] = {0,0,0,0};
  			colorShadow[] = {0,0,0,0};
   			colorBorder[] = {0,0,0,0};
			action = "closeDialog 0; [] call HRP_fnc_acceptCall";
		};
		class Decline_B: RscButton
		{
			idc = 1604;
			...
			colorFocused[] = {0,0,0,0};
  			colorShadow[] = {0,0,0,0};
   			colorBorder[] = {0,0,0,0};
			action = "closeDialog 0; [] call HRP_fnc_declineCall";
		};
		class ID_T: RscText
		{
			idc = 2131;
		...
		class RespondWText_B: RscButton
		{
			idc = 1605;
			...
			colorFocused[] = {0,0,0,0};
  			colorShadow[] = {0,0,0,0};
   			colorBorder[] = {0,0,0,0};
			action = "closeDialog 0; [] call HRP_fnc_respondWithText";
		};
	};
};
