HRP_fnc_serverInit = {
	["redroleplayframework", "SQL_CUSTOM", "redroleplayframework.ini"] spawn ExternalS_fnc_ExtDBinit; // Need to Update on Server
	sleep 3;
	...
	[true] spawn HRP_fnc_serverRestart; // True/False - Server will auto restart
