...
HRP_fnc_hudLoop ={
	...
	if ( HRP_Health < 100 ) then
		...
		if(HRP_Health == 0 || HRP_Dead) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_0.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 5 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_5.paa";
			_mylife ctrlSetText _message;
		};
		...
		if(HRP_Health < 15 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_15.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 20) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_10.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 25 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_25.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 30) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_20.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 35 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_35.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 40) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_40.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 45 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_45.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 50) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_50.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 55 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_55.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 60) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_60.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 65 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_65.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 70) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_70.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 5 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_75.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 80) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_80.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 85 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_85.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 90) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_90.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 95 ) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_95.paa";
			_mylife ctrlSetText _message;
		};
		if(HRP_Health < 100) exitwith {
			_message = "\RedRoleplay_Client2\icons\red_bar_100.paa";
			_mylife ctrlSetText _message;
		};
	} else
	{
...
if ( HRP_hunger > 0 ) then
	{
		if(HRP_Hunger < 5) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_95.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 10) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_90.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 15) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_85.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 20) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_80.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 25) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_75.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 30) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_70.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 35) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_65.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 40) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_60.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 45) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_55.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 50) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_50.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 55) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_45.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 60) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_40.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 65) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_35.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 70) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_30.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 75) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_25.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 80) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_20.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 85) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_15.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 90) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_10.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 95) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_5.paa";
			_myfood ctrlSetText _message;
		};
		if(HRP_Hunger < 100) exitwith {
			_message = "\RedRoleplay_Client2\icons\green_bar_0.paa";
			_myfood ctrlSetText _message;
		};
	} else
	{
			_message = "\RedRoleplay_Client2\icons\green_bar_100.paa";
			_myfood ctrlSetText _message;
	};
	...
	if ( HRP_Thirst > 0 ) then
	{
		if(HRP_Thirst < 5) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_95.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 10) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_90.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 15) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_85.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 20) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_80.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 25) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_75.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 30) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_70.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 35) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_65.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 40) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_60.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 45) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_55.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 50) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_50.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 55) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_45.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 60) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_40.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 65) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_35.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 70) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_30.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 75) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_25.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 80) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_20.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 85) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_15.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 90) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_10.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 95) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_5.paa";
			_mydrink ctrlSetText _message;
		};
		if(HRP_Thirst < 100) exitwith {
			_message = "\RedRoleplay_Client2\icons\blue_bar_0.paa";
			_mydrink ctrlSetText _message;
		};
	} else
	{
			_message = "\RedRoleplay_Client2\icons\blue_bar_100.paa";
			_mydrink ctrlSetText _message;
	};
